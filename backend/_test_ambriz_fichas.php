...
$request = Illuminate\Http\Request::create('/api/poa/fichas', 'GET', ['ejercicio_id' => 2027]);
...
try {
    ...
    $urg = \Illuminate\Support\Facades\DB::connection('poa_prod')->table('unidades_responsables_gastos')->where('nombre', 'LIKE', '%Ambriz%')->first();
